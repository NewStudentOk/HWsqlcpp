...
1. Спроектировать и нарисовать схему, как в [первой домашней работе](https://github.com/NewStudentOk/HWsqlcpp/tree/main/Less_1/Task_1). Прислать изображение со схемой.
